{
  ...
  inputs.src-ginger-v0_3_0.flake = false;
  inputs.src-ginger-v0_3_0.ref   = "refs/tags/v0.3.0";
  inputs.src-ginger-v0_3_0.owner = "Vindaar";
  inputs.src-ginger-v0_3_0.repo  = "ginger";
  inputs.src-ginger-v0_3_0.dir   = "";
  inputs.src-ginger-v0_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ginger-v0_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ginger-v0_3_0";
